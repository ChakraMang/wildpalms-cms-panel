                ...
                <ul className="list-group list-group-flush">
                  {basicInfo.map((item, ind) => (
                    ...
                    >
                      ...
                      <strong className="text-black"> {item.subtitle} </strong>
                    </li>
                  ))}
                </ul>
              ...
              <div className="card overflow-hidden">
                ...
                <div className="card-body">
                  <p>
                    ...
                    available, but the majority have. Nostrud tem exrcitation
                    duis laboris nisi ut aliquip sed duis aute cupidata. There
                ...
                <div className="property-card style-1">
                  ...
                  <div className="dz-content">
                        ...
                        <li className="">
                          <Link to={"#"}>
                            <svg
                              ...
                              width="24px"
                              height="24px"
                              viewBox="0 -16.33 127.9 127.9"
                              version="1.1"
                              id="Layer_1"
                              xmlns="http://www.w3.org/2000/svg"
                              style={{
                                enableBackground: "new 0 0 127.9 95.25",
                              }}
                            >
                              <g>
                    ...
                    <div className="dz-footer">
                      ...
                      <ul>
                        <li>
                          <Link to={"#"} onClick={() => handleShare(item?.key)}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                        ...
                        <li>
                          <Link to={`/property-details/${item?.key}`}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
