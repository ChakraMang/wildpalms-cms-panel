        ...
        <div className="col-xl-6 col-xxl-12">
          <div className="row">
            ...
            <div className="col-sm-6">
              <div className="card">
                <div className="card-header align-items-center border-0 pb-0">
                  <span className="fs-36 text-black pr-3 d-flex align-items-center font-w600 me-auto">
                    34%
                    <svg
                      className="ms-1"
                      width={14}
            ...
            <div className="col-sm-6">
              <div className="card">
                <div className="card-header align-items-center border-0 pb-0">
                  <span className="fs-36 text-black font-w600 me-auto">
                    4%
                    <svg
                      className="ms-1"
                      width={14}
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="d-flex mt-3">
                    <span className="text-black font-w600 me-5">
                      <svg
                        className="me-2"
                        width={20}
                        height={20}
