...
function OrderList() {
  ...
  const orderData = [
    {
      ...
      propertyName: "Sharayu",
      location: "Siolim",
      amount: "₹20000",
      rentalType: "Long stay Rental",
      company: "Wildpalms Hospitality",
      status: "Approved",
    },
    {
      orderId: "#wpo00002",
  ...
  const getNextOptions = (status) => {
    switch (status) {
      case "Pending":
        return ["Accept order", "Reject order", "Negotiate"];
      case "Approved":
        return ["View Details"];
      case "Negotiation":
  ...
  return (
    <>
      <div className="form-head page-titles d-flex  align-items-center">
        ...
        <Link to="/order-list" className="btn btn-primary rounded light me-3">
          Refresh
        </Link>
            ...
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body">
                  <h3>7</h3>
                  <span className="fs-14 text-black">Total Customers</span>
                </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body">
                  <h3>7</h3>
                  <span className="fs-14 text-black">Total Transactions</span>
                </div>
                <span className="bg-primary rounded p-3">
                  <svg
                    width={28}
              ...
              >
                ...
                <tbody>
                  ...
                  {orderData.map((item, ind) => (
                    <tr role="row" className={ind % 2 === 0 ? "odd" : "even"}>
                      <td className="orderList_sorting_1">
                        <div className="form-check custom-checkbox ms-2">
                          <input
                            type="checkbox"
                      ...
                      <td className="text-ov">{item?.propertyName}</td>
                      <td className="text-ov">{item?.location}</td>
                      <td>{item?.amount}</td>
                      ...
                      <td>
                        <Dropdown className="ms-auto">
                          ...
                          <Dropdown.Menu className="dropdown-menu-right">
                            {getNextOptions(item.status).map(
                              (option, index) => (
                                <Dropdown.Item
                                  key={index}
