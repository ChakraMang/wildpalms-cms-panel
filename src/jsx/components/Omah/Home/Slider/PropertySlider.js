        ...
        {properties?.map((item, ind) => (
          <SwiperSlide key={ind}>
            <div className="items">
              ...
              <span className="fs-14 d-block mb-4">{item?.location}</span>
              <Link
                to="#"
                className="bgl-primary text-black p-1 ps-2 pe-2 me-3 font-w600 rounded"
              >
                <svg
                  className="me-2"
                  width={20}
              ...
              <Link
                to="#"
                className="bgl-primary text-black p-1 ps-3 pe-3 font-w600 rounded"
              >
                <svg
                  className="me-2"
                  width={13}
              ...
              <p className="fs-14 mt-3 mb-0">{item?.description}</p>
            </div>
          </SwiperSlide>
        ))}
